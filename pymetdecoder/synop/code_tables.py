...
class _CodeTable0161(CodeTable):
    """
...
class _CodeTable0264(CodeTable):
    """
    ...
    def _decode(self, a3):
        if self._SURFACES[int(a3)] is None:
            raise ValueError(a3)
        return self._SURFACES[int(a3)]
    def _encode(self, data):
        return str(self._SURFACES.index(data["value"]))
class _CodeTable0500(CodeTable):
    """
    Genus of cloud
    """
    _TABLE = "0500"
...
class _CodeTable0700(CodeTable):
    """
    ...
    def _encode(self, data):
        ...
        if dir is None:
            if "stationary" in data and data["stationary"]:
                return "0"
            elif "all_directions" in data and data["all_directions"]:
                return "9"
        return dir
class _CodeTable0739(CodeTable):
    """
    ...
    def _encode(self, data):
        ...
        raise pymetdecoder.EncodeError()
class _CodeTable0833(CodeTable):
    """
    ...
    def _encode(self, data):
        pass
class _CodeTable0877(CodeTable):
    """
    ...
    def _encode(self, data):
        ...
        return code
class _CodeTable1600(CodeTable):
    """
...
class _CodeTable1677(CodeTable):
    """
...
class _CodeTable1751(CodeTable):
    """
    ...
    def _encode(self, data):
        ...
        for idx, v in enumerate(self._VALUES):
            ...
            if spray == v["spray"] and fog == v["fog"] and rain == v["rain"]:
                return idx
        raise Exception()
class _CodeTable1806(CodeTable):
    """
    ...
    def _decode(self, i):
        ...
        return None
class _CodeTable2700(CodeTable):
    """
    Total cloud cover
    """
    _TABLE = "2700"
...
class _CodeTable3552(CodeTable):
    """
    ...
    def _encode(self, data):
        pass
class _CodeTable3590(CodeTable):
    """
...
class _CodeTable3590A(CodeTable):
    """
...
class _CodeTable3850(CodeTable):
    """
    ...
    def _encode(self, data):
        ...
        if data["value"] >= 0:
            ...
            return str((2 * m) + 1)
class _CodeTable3855(CodeTable):
    """
    ...
    def _encode(self, data):
        ...
        raise Exception
class _CodeTable3889(CodeTable):
    """
    Total depth of snow
    """
    _TABLE = "3889"
    ...
    def _encode(self, data):
        if "depth" in data and data["depth"] is not None:
            ...
            raise Exception
class _CodeTable4019(CodeTable):
    """
...
class _CodeTable4077(CodeTable):
    """
    Time before observationor duration of phenomena
    Variation, location or intensityof phenomena
    """
    _TABLE = "4077"
    def _decode(self, tz):
        tz = int(tz)
        if 0 <= tz <= 60:
            return { "value": 6 * tz, "unit": "min" }
        raise ValueError(tz)
    def _encode(self, data):
        pass
class _CodeTable4377(CodeTable):
    """
    ...
    def _encode(self, data, use90=False):
        ...
        # If we reach this point, we've been unable to encode
        raise pymetdecoder.EncodeError("Cannot encode visibility {}".format(value))
class _CodeTable4451(CodeTable):
    """
